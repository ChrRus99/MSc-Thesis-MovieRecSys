...
class PopularityRanking:
    ...
    It provides methods to retrieve the top movies according to IMDB's weighted rating formula and
    the top movies for a specific genre.

    """

    @staticmethod
    def top_movies_IMDB_wr_formula(tabular_dataset_handler, top_n):
        """
        ...
        Parameters:
            ...
            top_n (int): The number of top movies to recommend.
        ...
        return PopularityRanking._top_movies_IMDB_wr_formula(movies_df, top_n)

    @staticmethod
    def top_movies_for_genre(tabular_dataset_handler, genre, top_n):
        """
        Returns the top N most popular movies of the specified genre according to IMDB's weighted
        rating formula.
        ...
        Parameters:
            ...
            top_n (int): The number of top movies to recommend for the specified genre.

        Returns:
            pd.DataFrame: The top N movies of the specified genre based on IMDB's weighted rating 
                ('wr').
        """
        ...
        return PopularityRanking._top_movies_IMDB_wr_formula(genre_movies_df, top_n).rename(columns={'genres': 'genre'})

    @staticmethod
    def _top_movies_IMDB_wr_formula(movies_df, top_n, percentile=0.85):
        """
