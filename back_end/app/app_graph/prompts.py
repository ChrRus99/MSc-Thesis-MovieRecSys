...
# "web_search": "What is the plot of The Matrix?", "How Jumanji movie was reviewed?", "Was the movie matrix appreciated by critics?", "Is Top Gun a good movie?" [articulated information and users's opinions or reviews which need to be retrieved from the web]
