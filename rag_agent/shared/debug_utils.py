...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# MY COMMENT: questo file è dublicato con quello di main_graph
# creare una classe astratta comune per i due AgentState e creare un file unico shared/debug_utils.py

# lo stesso vale per shared/utils.load_chat_model
# lo stesso vale per human_node e take_handoff_tool in graph
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
